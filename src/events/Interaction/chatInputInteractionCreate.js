const { Events, Collection, MessageFlags, ChannelType } = require("discord.js")
...
module.exports = {
	...
	async execute(interaction) {
		...
		try {
			...
			if (command.options && command.options?.bot_permissions && !command.options?.DM && !guild?.members?.me?.permissions?.has(command.options?.bot_permissions)) {
